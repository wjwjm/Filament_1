...
"$PYTHON" "$REPO/Filament_python/tools/hpc_ops/provenance_v2.py" create --repo "$REPO" --output "$RUN_ROOT/hr4e5s_s4r_provenance_v2.json" --tracked Filament_python/KHz_filament/hr4.py Filament_python/KHz_filament/hr4e5s_streaming.py Filament_python/KHz_filament/hr4e5s_s3.py Filament_python/KHz_filament/hr4e5s_s4r.py Filament_python/tools/run_hr4e5s_s4r.py Filament_python/tools/hr4e5s_s4r.sbatch Filament_python/tools/hpc_ops/run_hr4e5s_s4r_preflight.sh Filament_python/tools/hpc_ops/submit_hr4e5s_s4r.sh Filament_python/tools/hpc_ops/audit_batch_entry.py --external "$INPUT_MANIFEST" "$SOURCE_MANIFEST" "$SOURCE_STATE" "$SOURCE_CONFIG" >/dev/null
