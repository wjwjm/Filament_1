...
if ! "$PYTHON" "$REPO/Filament_python/tools/hpc_ops/provenance_v2.py" create --repo "$REPO" --output "$PROVENANCE" \
  --tracked Filament_python/KHz_filament/hr4.py Filament_python/KHz_filament/hr4c_state.py Filament_python/KHz_filament/hr4e_domain.py Filament_python/KHz_filament/hr4e5_parallel.py Filament_python/KHz_filament/hr4e5p_launcher.py Filament_python/KHz_filament/hr4e_timestep.py Filament_python/tools/run_hr4e5p.py Filament_python/tools/hr4e5p_parallel.sbatch Filament_python/tools/hpc_ops/launch_hr4e5p_p3_async.sh Filament_python/tools/hpc_ops/run_hr4e5p_preflight.sh Filament_python/tools/hpc_ops/submit_hr4e5p_stage1.sh Filament_python/tools/hpc_ops/submit_hr4e5p_p3.sh Filament_python/tools/hpc_ops/stage_hr4e5p_worktree.sh \
