...
"$PYTHON" "$REPO/Filament_python/tools/hpc_ops/audit_hr4e5s_s3_lut_workspace.py" --config "$SOURCE_CONFIG" --workspace "$LUT_WORKSPACE" --out "$RUN_ROOT/hr4e5s_s3_lut_workspace.json" >"$RUN_ROOT/hr4e5s_s3_lut_workspace.stdout.json"
