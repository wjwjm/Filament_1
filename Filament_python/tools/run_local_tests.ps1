...
$targetedTests = @(
    ...
    (Join-Path $filamentPythonRoot 'tests\test_hr4d_pulse_lifecycle.py'),
    (Join-Path $filamentPythonRoot 'tests\test_hr4e1_timestep.py'),
    (Join-Path $filamentPythonRoot 'tests\test_hr4e2c_real.py'),
    (Join-Path $filamentPythonRoot 'tests\test_hr4e2c_adjudication.py'),
    (Join-Path $filamentPythonRoot 'tests\test_hr4e2c_velocity_diagnostic.py'),
    ...
    (Join-Path $filamentPythonRoot 'tests\test_hr4e5_e5_1a.py'),
    (Join-Path $filamentPythonRoot 'tests\test_hr4e5_e5_1a_entry_refusals.py'),
    (Join-Path $filamentPythonRoot 'tests\test_hr4e5_e5_1a_r.py'),
