...
# n - 1 = A/(238.0185 - sigma^2) + B/(57.362 - sigma^2), sigma=1/λ(μm).
# The fitted A/B coefficients already contain the refractivity scaling.
# 近可见红外有效；P,T 做线性密度缩放
def n_air_ciddor_simple(lambda_um, P=101325.0, T=293.15):
    sigma2 = (1.0 / xp.maximum(lambda_um, 1e-9))**2
    d = 0.05792105 / (238.0185 - sigma2) + 0.00167917 / (57.362 - sigma2)
    # 密度缩放（~理想气体）：与 (P/T) 比例
