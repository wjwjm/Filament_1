...
def _parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--skip-plots", action="store_true", help="Skip matplotlib plotting and only write numeric outputs")
...
def main() -> int:
    ...
    plot_enabled = not bool(args.skip_plots)
    if plot_enabled and importlib.util.find_spec("matplotlib") is None:
        print("[ion-lut-validate] WARNING: matplotlib not found; plotting disabled (numeric outputs still saved).")
        plot_enabled = False
    elif not plot_enabled:
        print("[ion-lut-validate] plotting disabled by --skip-plots.")
